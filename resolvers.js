        ...
        addListPart(parent,args,context) {
            return context.db.ListPartModel.sync().then(function () {
                return context.db.ListPartModel.create({
                  ...
                  parentlistids: context.db.Sequelize.fn('array_append',  context.db.Sequelize.col('parentlistids'), parent.dataValues.id),
                  type:args.type,
                  ...
                  listid:null//TODO
                    ...
                    context.db.UserModel.update({
                        listids: context.db.Sequelize.fn('array_append',  context.db.Sequelize.col('listids'), data.dataValues.id)
                    }, {
